  ...
  render: function() {
    return (
      <div>
        ...
        <span>
          <a className="btn add-del-edit del" href={"/tabs/" + this.props.obj.id} data-confirm="Are you sure you want to delete this tab?" title="Delete Tab" data-remote="true" rel="nofollow" data-method="delete">
            <img src={"http://icons.iconarchive.com/icons/dryicons/simplistica/48/delete-icon.png"} alt="Delete"/>
          </a>
        </span>
      </div>
    )
